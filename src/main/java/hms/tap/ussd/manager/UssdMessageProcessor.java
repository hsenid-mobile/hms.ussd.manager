...
import hms.tap.ussd.manager.repo.SessionRepo;
...
import static hms.tap.ussd.manager.menu.MenuUtil.getMenuId;
import static hms.tap.ussd.manager.menu.MenuUtil.getOperationType;
import static hms.tap.ussd.manager.menu.MenuUtil.isIndexMenu;
...
public class UssdMessageProcessor {
     ...
     * In memory database {@link hms.tap.ussd.manager.repo.GuavaSessionRepo}. Default {@link hms.tap.ussd.manager.menu.DefaultFirstMenu} and
     * default {@link hms.tap.ussd.manager.conf.AppConfig}
     * @param builder
     */
