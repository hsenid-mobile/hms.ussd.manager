 ...
 * {@link Menu#getMessage(hms.ussd.manager.Session, hms.tap.api.ussd.messages.MoUssdReq)} will help to get the menus message (i.e menu content).
 * {@link Menu#getNextMenu(hms.ussd.manager.Session, hms.tap.api.ussd.messages.MoUssdReq)} this method will be called as soon as user send an input for this menu.
...
public interface Menu {
     ...
     *
     * @param session   {@link hms.ussd.manager.Session} object.
